 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.thevillage.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.kofiagyeman.thevillage'; // ios bundle id
const PACKAGE = 'com.kofiagyeman.thevillage'; // android package name
const NAME = 'The Village'; // app name
const EXPO_ACCOUNT_OWNER = 'kofiagyeman'; // expo account owner
const EAS_PROJECT_ID = 'eaabdffe-2044-41ed-b688-1af6a93fd839'; // eas project id
const SCHEME = 'TheVillage'; // app scheme
